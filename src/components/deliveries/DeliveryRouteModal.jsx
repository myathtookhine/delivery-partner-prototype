  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col bg-white">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-100 shrink-0">
        <h2 className="text-lg font-bold text-gray-900">Delivery Route</h2>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        >
          ...
          >
            ...
            <Marker position={[startLocation.lat, startLocation.lng]}>
              <Popup>{startLocation.name} (Pickup)</Popup>
            </Marker>
            <Marker position={[endLocation.lat, endLocation.lng]}>
              <Popup>{endLocation.name} (Destination)</Popup>
            </Marker>
          </MapContainer>
        ...
        {/* Right side: Delivery Info + Packages — scrollable */}
            ...
            <div>
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-xl">
                <div className="flex items-center">
                  ...
                  <div className={`text-2xl font-bold me-3 ${batchIconColor}`}>
                    {batch.batchNo}
                  </div>
                </div>
